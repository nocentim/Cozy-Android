...
// export
if (typeof module !== 'undefined') module.exports = Showdown;// Generated by CoffeeScript 1.3.3
(function() {
  ...
  initPage = function() {
    ...
    $("body").html('<div id="editorContent" class="table-ly-ctnt"><iframe id="editorIframe"><html id="__ed-iframe-html"><head><link rel="stylesheet" href="stylesheets/app.css"></head><body id="__ed-iframe-body" contenteditable="true"></body></html></iframe></div>');
    console.log($("body"));
    editorIframe$ = $("iframe");
    console.log('et hop');
    ...
    cb = function() {
      var addClassToLines, editorBody$, editorCtrler, getSelectedLines,
        _this = this;
      this.deleteContent();
      editorCtrler = this;
  ...
  CNEditor = (function() {
    ...
    */
    ...
    function CNEditor(iframeTarget, callBack) {
      ...
      iframe$.on('load', function() {
        ...
        _this._lastKey = null;
        _this._sandBox = document.createElement('div');
        _this._sandBox.setAttribute('contenteditable', true);
        _this._sandBox.setAttribute('display', "none");
        _this.editorIframe.appendChild(_this._sandBox);
    ...
    */
    ...
    CNEditor.prototype.paste = function(event) {
      var range, savedSel, sel;
      savedSel = rangy.saveSelection(rangy.dom.getIframeWindow(this.editorIframe));
      sel = rangy.getIframeSelection(this.editorIframe);
      range = rangy.createRange();
      range.collapseToPoint(this._sandBox, 0);
      sel.setSingleRange(range);
      if (event && event.clipboardData && event.clipboardData.getData) {
        if (event.clipboardData.types === "text/html") {
          this._sandBox.innerHTML = event.clipboardData.getData('text/html');
        } else if (event.clipboardData.types === "text/plain") {
          this._sandBox.innerHTML = event.clipboardData.getData('text/plain');
        } else {
          this._sandBox.innerHTML = "";
        }
        this._waitForPasteData(this._sandBox, this._processPaste, savedSel);
    ...
    CNEditor.prototype._waitForPasteData = function(sandbox, processpaste, savedSel) {
      ...
      return (waitforpastedata = function(elem) {
        ...
        if (elem.childNodes && elem.childNodes.length > 0) {
          ...
          return setTimeout(that.callself, 20);
        }
      })(sandbox);
    };

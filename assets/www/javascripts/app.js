...
window.require.define({"views/templates/editor": function(exports, require, module) {
  ...
  buf.push('><iframe');
  buf.push(attrs({ 'id':('editorIframe'), 'src':("#") }));
...
window.require.define({"views/templates/test_11": function(exports, require, module) {
  ...
  buf.push('><span>elt 1</span><br');
  buf.push(attrs({  }));
  buf.push('/></div><div');
  buf.push(attrs({ "class": ('Lo-2') }));
  buf.push('><span>elt 1.1</span><br');
  buf.push(attrs({  }));
  buf.push('/></div><div');
  buf.push(attrs({ "class": ('Lo-2') }));
  buf.push('><span>elt 1.2</span><br');
  buf.push(attrs({  }));
  buf.push('/></div><div');
  buf.push(attrs({ "class": ('To-2') }));
  buf.push('><span>elt 3</span><br');
  buf.push(attrs({  }));
  buf.push('/></div><div');
  buf.push(attrs({ "class": ('To-2') }));
  buf.push('><span>elt 4</span><br');
  buf.push(attrs({  }));
  buf.push('/></div><div');
  buf.push(attrs({ "class": ('To-2') }));
  buf.push('><span>elt 5</span><br');
  buf.push(attrs({  }));
  buf.push('/></div><div');
  buf.push(attrs({ "class": ('To-2') }));
  buf.push('><span>elt 6</span><br');
  buf.push(attrs({  }));
  buf.push('/></div>');
  }
  return buf.join("");

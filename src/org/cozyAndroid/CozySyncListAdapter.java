...
public class CozySyncListAdapter extends CouchbaseViewListAdapter {
	...
	public CozySyncListAdapter(TabListe parent, CouchDbConnector couchDbConnector, ViewQuery viewQuery) {
	...
	public View getView(int position, View itemView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.liste_notes, null);

...
public class TabPlus extends Activity implements View.OnClickListener {
	...
	private View.OnClickListener BIUListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			//TODO finir de mettre les autres sous classe en variable d'instance puis repercuter cette modification sur le code de onCreate()
			// il faut aussi voir pour la gestion de la ligne commentée ci dessous et de ce que ca implique: la gestion du listener de l'edittext
//			newText.removeTextChangedListener(TabPlus.TextListener.this) ;
